...
describe('VideoGenerator', () => {
    ...
    describe('createSilentVideo', () => {
        it('should create silent video from image', async () => {
            const mockImageToVideo = jest.spyOn(ffmpegUtils, 'imageToVideo').mockResolvedValue();
    ...
    describe('mergeAudioVideo', () => {
        it('should merge audio and video files', async () => {
            const mockMerge = jest.spyOn(ffmpegUtils, 'mergeAudioVideo').mockResolvedValue();
    ...
    describe('getAudioDuration', () => {
        it('should return audio duration', async () => {
            const mockGetDuration = jest.spyOn(ffmpegUtils, 'getMediaDuration').mockResolvedValue(10.5);
    ...
    describe('concatVideos', () => {
        it('should concatenate multiple videos', async () => {
            const mockConcat = jest.spyOn(ffmpegUtils, 'concatMedia').mockResolvedValue();
        ...
        it('should handle empty video list', async () => {
            const mockConcat = jest.spyOn(ffmpegUtils, 'concatMedia');
